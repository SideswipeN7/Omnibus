...
public class MainActivity extends AppCompatActivity {
    ...
    class GetScoresTask extends AsyncTask<Void, Void, Void> {


        protected Void doInBackground(Void... u) {
            mDb = Omnibus.getSingelton();
            mDb.getMyScores(mUserId);
            return null;
        }
